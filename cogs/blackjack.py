...
@commands.slash_command(guild_ids=server, name='deposit', description='Admins can deposit money to a user')
...
@commands.slash_command(guild_ids=server, name='balance', description='Check your balance')
...
@commands.slash_command(guild_ids=server, name='redeem', description='Redeem a money voucher')
...
@commands.slash_command(guild_ids=server, name='transfer', description='Transfer your balance to another user')
...
@commands.slash_command(guild_ids=server, name="stats", description="Show your Blackjack stats")
async def stats(ctx):
    user_id = ctx.author.id
